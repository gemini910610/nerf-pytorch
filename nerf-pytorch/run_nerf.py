...
np.random.seed(0)
torch.manual_seed(0) # modify
torch.cuda.manual_seed(0) # modify
DEBUG = False
...
def config_parser():
    ...
    # training options
    parser.add_argument('--N_iters', type=int, default=200000, help='number of training epochs') # modify
...
def train():
    ...
    N_iters = args.N_iters + 1 # 200000 + 1 # modify
    print('Begin')
